...
<div class="space-y-6">
  <div class="bg-blue-50 p-4 rounded-lg">
    <h3 class="text-lg font-semibold text-blue-800 mb-2">Message Logger Demo</h3>
    <p class="text-blue-700">
      This demo shows basic RabbitMQ queue functionality. Messages are sent to a queue and displayed in real-time via WebSocket.
    </p>
  </div>
